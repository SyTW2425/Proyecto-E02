...
describe('POST /api/users', () => {
  ...
  it('debería crear un nuevo usuario', async () => {
    ...
    expect(response.body).to.have.property('msg', 'El usuario se ha creado con éxito');
  ...
  it('debería devolver un error si el email ya existe', async () => {
    ...
    expect(response.body).to.have.property('msg', 'Ya existe un usuario con ese email');
  });
