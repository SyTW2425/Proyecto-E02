...
//     const response = await request(app)
//       .patch(`/cards/${card.name}`)
//       .send(updatedCard)
//       .expect(200);

//     expect(response.body).to.have.property('name', 'Card2');
//   });
...
//     const response = await request(app)
//       .put('/cards/invalidcard')
//       .send(updatedCard)
//       .expect(404);

//     expect(response.body).to.have.property('error', 'Card not found');
//   });
//  });
 ...
 describe('DELETE /cards/:_id', () => {
  it('debería eliminar una carta existente', async () => {
    ...
    expect(response.body).to.have.property('msg', 'Card deleted successfully');
  });
  it('debería devolver un error si la carta no existe', async () => {
    const response = await request(app)
