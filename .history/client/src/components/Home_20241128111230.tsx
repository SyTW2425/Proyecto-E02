    ...
    <div className="fullscreen-container">
      ...
      <main>
        <div className="wrapper">
            ...
            <section className="section" style={{ backgroundImage: 'url(/images/mis-cartas-background.webp)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
                <Link to={`/cartas/${localStorage.getItem('nombre_usuario')}`} className="link-button">
                  <img src="/images/img-registro.jpg" alt="Icono de registro"></img>
                  <h2>Mis Cartas</h2>
                </Link>
            </section>
