    ...
    <div className="fullscreen-container">
      ...
      <main>
        <div className="wrapper">
            ...
            <section className="section" style={{ backgroundImage: 'url(/images/mis-cartas-background.png)', backgroundSize: 'auto', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
